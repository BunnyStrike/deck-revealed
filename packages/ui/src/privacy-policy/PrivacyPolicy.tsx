...
const PrivacyPolicy = (props: PrivacyPolicyProps) => {
  ...
  return (
    <div>
      ...
      <p>
        {legalName} (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;) operates the {props.url}{' '}
        website
        {props.mobile ? `and the ${props.mobile} mobile application` : ''} (the
        &quot;Service&quot;).
      </p>
      <p>
      ...
      <ul>
        <li>
          ...
          <p>
            Service means the {url} website and the Games Revealed mobile application operated by{' '}
            {legalName}
          </p>
        </li>
        <li>
      ...
      <p>
        If you are from the European Economic Area (EEA), {legalName} legal basis for collecting and
      ...
      <p>
        {legalName} will retain your Personal Data only for as long as is necessary for the purposes
      ...
      <p>
        {legalName} will also retain Usage Data for internal analysis purposes. Usage Data is
      ...
      <p>
        {legalName} will take all steps reasonably necessary to ensure that your data is treated
      ...
      <p>
        If {legalName} is involved in a merger, acquisition or asset sale, your Personal Data may be
      ...
      <p>
        Under certain circumstances, {legalName} may be required to disclose your Personal Data if
        required to do so by law or in response to valid requests by public authorities (e.g. a
        court or a government agency).
      </p>
      <h4>Legal Requirements</h4>
      <p>
        {legalName} may disclose your Personal Data in the good faith belief that such action is
        necessary to:
      </p>
      <ul>
      ...
      <p>
        ...
        rights. {props.legalName} aims to take reasonable steps to allow you to correct, amend,
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            consent at any time where {props.legalName}
      ...
      <ul>
        ...
        {renderGoogleAdmob() && (
          <li>
            ...
            <p>
              You can opt-out from AdMob by Google service by following the instructions described
              by Google:{' '}
        ...
        {(props.advertising || []).map((item: any, i: React.Key | null | undefined) => (
      ...
      <p>
        {props.legalName} uses remarketing services to advertise on third party websites to you
      ...
      <ul>
        ...
        {(props.remarketing || []).map((item: any, i: React.Key | null | undefined) => (
          <PrivacyPolicyList key={i} item={item}></PrivacyPolicyList>
        ))}
      </ul>
      {/* 3. Payments */}
      ...
      <ul>
        ...
        {(props.payments || []).map((item: any, i: React.Key | null | undefined) => (
          <PrivacyPolicyList key={i} item={item}></PrivacyPolicyList>
        ))}
      </ul>
      {/* 4. */}
      ...
      <p>
        We may collect data inputted by you and store it in database and/or file storage for later
        use by you or other users. we might use the data to improve the user experience.
      </p>
      <p>
        We will not store or collect your sensitive information with out taking proper measure to
        secure it. we will either use a server or service to store the data
      </p>
      ...
      <ul>
        {renderFirebaseService() && (
          <li>
            ...
            <p>
              Firebase stores and manages data for users and the customer that can be used for
              analytics, authentication, push notifications, testing, hosting, and linking.{''}
            </p>
            <p>
              For more information on the privacy practices of Google, please visit the Google
              Privacy & Terms web page:{''}
        ...
        {(props.storage || []).map((item: any, i: React.Key | null | undefined) => (
          <PrivacyPolicyList key={i} item={item}></PrivacyPolicyList>
        ))}
      </ul>
      {/**/}
