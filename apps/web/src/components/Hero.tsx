...
function Chart({
  ...
  for (let index = 0; index < prices.length; index++) {
    ...
    const y =
      paddingY +
      (1 - ((prices[index] ?? 0) - minPrice) / (maxPrice - minPrice)) * height
    points.push({ x, y })
  ...
  return (
      ...
      {...(interactionEnabled
        ? {
            ...
            onPointerMove: (event: any) => {
              ...
              onChangeActivePointIndex?.(closestPointIndex ?? 0)
            },
          }
        : {})}
      {...props}
    >
      ...
      <motion.path
        ...
        onUpdate={({ pathLength = 0 }: { pathLength: number }) => {
          pathWidth.set(
...
function AppDemo() {
  ...
  const activeValue = prices[activePriceIndex] || 0
  const previousValue = prices[activePriceIndex - 1] || 0
          ...
          <div className='mt-3 border-t border-gray-200 pt-5'>
            ...
            <div className='mt-3 rounded-lg bg-gray-50 ring-1 ring-inset ring-black/5'>
              <Chart
                ...
                onChangeActivePointIndex={setActivePointIndex as any}
              />
            </div>
