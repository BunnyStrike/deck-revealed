  ...
  return (
    <form className='relative isolate mt-8 flex items-center pr-1'>
      ...
      <input
        ...
        className='peer w-0 flex-auto border-none bg-transparent px-4 py-2.5 text-base text-white placeholder:text-gray-500 focus:outline-none sm:text-[0.8125rem]/6'
      />
