...
import {
  type GOGCloudSavesLocation,
  type GogInstallPlatform,
} from './types/gog'
import { type LegendaryInstallPlatform } from './types/legendary'
...
// 'exe' | 'msi' | 'web' | 'direct' | 'pacman' | 'flathub' | 'app' | 'snap'
...
export type WebviewType = HTMLVideoElement & ElWebview // HTMLWebViewElement
