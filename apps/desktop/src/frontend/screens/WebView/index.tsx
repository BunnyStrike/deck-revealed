...
import './index.css'
import { RevealedEpic } from '../../platforms/epic'
import { RevealedGog } from '../../platforms/gog'

// import LoginWarning from '../Login/components/LoginWarning'

const epic = new RevealedEpic()
const gog = new RevealedGog()
...
export default function WebView() {
  ...
  const wikiURL = 'https://github.com/BunnyStrike/revealed-desktop-app/wiki'
