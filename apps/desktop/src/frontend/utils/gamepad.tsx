...
export const initGamepad = (
  ...
  let revealedIsFocused = true
  window.addEventListener('focus', () => (revealedIsFocused = true))
  window.addEventListener('blur', () => (revealedIsFocused = false))
  ...
  function checkAction(
    ...
    if (!revealedIsFocused) {
      // ignore gamepad events if revealed is not the focused app
      //
    ...
    if (wasActive) {
      ...
      if (data.repeatDelay) {
        const lastTriggered = triggeredAt ?? 0
