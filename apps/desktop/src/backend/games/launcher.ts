...
// import {
//   type CallRunnerOptions,
//   type EnviromentVariable,
//   type ExecResult,
//   type GameInfo,
//   type GameSettings,
//   type LaunchPreperationResult,
//   type RpcClient,
//   type Runner,
//   type SideloadGame,
//   type WineCommandArgs,
//   type WineInstallation,
//   type WrapperVariable,
// } from '~/common/types'
...
// } from '../utils'
// import { type GOGGame } from './gog/games'
// import setup from './gog/setup'
// import { type LegendaryGame } from './legendary/games'
...
//  * @param gameSettings The GameSettings to get the environment variables for
//  * @param gameId If Proton and the Steam Runtime are used, the SteamGameId variable will be set to `revealed-gameId`
...
//     ret.SteamGameId = `revealed-${gameId}`
