...
import { type GameConfigVersion, type GameSettings } from '~/common/types'
import {
...
abstract class GameConfig {
  ...
  protected constructor(appName: string) {
    ...
    this.path = join(revealedGamesConfigPath, appName + '.json')
  }
  ...
  public static get(appName: string): GameConfig {
    ...
    const path = join(revealedGamesConfigPath, appName + '.json')
